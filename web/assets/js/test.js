...
start_song.onclick = function() {
	...
	metronome.playSound(audioContext, audioStreamController, score_renderer, parseInt(bpm_slider.value), parseInt(step_offset_select.value), beats_per_measure, beats_per_measure * vf_bars.length, 1);
};
