...
function () {
  ...
  _createClass(SessionController, [{
    ...
    value: function complete(session_controller) {
      ...
      session_controller.playingState = false; // TODO: show result box
