...
/******/ 	return __webpack_require__(__webpack_require__.s = "./web/assets/js/layout.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* WEBPACK VAR INJECTION */(function($) {var logout = document.getElementById("logout");

logout.onclick = function () {
  $('<form action="' + '/' + '" method="POST"><input type="hidden" name="action_type" value="logout"></form>').appendTo($(document.body)).submit();
};

var account_info = document.getElementById("my_account");
